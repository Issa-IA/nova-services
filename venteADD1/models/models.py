...
class SaleOrderHerit(models.Model):
    ...
    def sale_marge_reel_fuc(self):
        for rec in self:
            rec.sale_marge_reel =rec.sale_total_rachat+ rec.sale_finance -rec.sale_montatnt_IR + rec.sale_frais - rec.sale_total_achat - rec.sale_frais_restitution - rec.sale_vr_client - rec.sale_ir_prospects - rec.sale_vr_client_2 - rec.sale_rachat_matriel - rec.sale_Gratuite - rec.sale_partenariat - rec.sale_solde_2_fois
